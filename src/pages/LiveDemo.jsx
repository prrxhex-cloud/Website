...
import { Crosshair, ShieldCheck, Zap, Radio, Sliders, Play, Eye } from 'lucide-react';
    ...
    const render = () => {
      ...
      enemies.forEach(e => {
        ...
        if (currentControls.tracers) {
          ...
          ctx.strokeStyle = e === activeTarget && currentControls.aimbot 
            ? 'rgba(239, 68, 68, 0.8)' 
            : 'rgba(139, 92, 246, 0.5)';
          ctx.lineWidth = 1.5;
          ctx.stroke();
