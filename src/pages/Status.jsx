...
export default function Status() {
  ...
  const total = services.length > 0 ? services.length : 6;
  const online = services.length > 0 ? services.filter(s => s.status === 'online').length : 6;
